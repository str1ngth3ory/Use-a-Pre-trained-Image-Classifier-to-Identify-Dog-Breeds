...
def calculates_results_stats(results_dic):
    ...
    if n_dogs_img == 0:
        print('There is no image of dog.')
    else:
    ...
    if n_notdogs_img == 0:
        print('All the images are of dog.')
    else:
    ...
    if n_image == 0:
        ...
        results_stats_dic['pct_match'] = n_match / n_image * 100.0
